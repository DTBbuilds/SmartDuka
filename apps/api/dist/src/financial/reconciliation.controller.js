...
let ReconciliationController = class ReconciliationController {
    ...
    async createReconciliation(dto, user) {
        return this.reconciliationService.createDailyReconciliation(user.shopId, new Date(), dto.actualCash, user.sub, dto.reconciliationNotes);
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [reconciliation_dto_1.CreateDailyReconciliationDto, Object]),
...
__decorate([
    ...
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [reconciliation_dto_1.GetReconciliationHistoryDto, Object]),
    __metadata("design:returntype", Promise)
], ReconciliationController.prototype, "getHistory", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ReconciliationController.prototype, "getVarianceReport", null);
__decorate([
    (0, common_1.Put)(':id/investigate'),
    (0, roles_decorator_1.Roles)('admin'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, reconciliation_dto_1.InvestigateVarianceDto, Object]),
    __metadata("design:returntype", Promise)
], ReconciliationController.prototype, "investigateVariance", null);
__decorate([
    ...
    __param(2, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, reconciliation_dto_1.ApproveReconciliationDto, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ReconciliationController.prototype, "getStats", null);
exports.ReconciliationController = ReconciliationController = __decorate([
    (0, common_1.Controller)('financial/reconciliation'),
