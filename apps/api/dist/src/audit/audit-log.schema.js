...
], AuditLog.prototype, "shopId", void 0);
__decorate([
...
exports.AuditLogSchema.index({ shopId: 1, createdAt: -1 });
exports.AuditLogSchema.index({ userId: 1, createdAt: -1 });
exports.AuditLogSchema.index({ branchId: 1, createdAt: -1 });
exports.AuditLogSchema.index({ action: 1 });
exports.AuditLogSchema.index({ resource: 1 });
