...
let ReportsController = class ReportsController {
    ...
    async getDailySalesReport(dateStr, user) {
        const date = dateStr ? new Date(dateStr) : new Date();
        return this.reportsService.getDailySalesReport(user.shopId, date);
    }
    async getWeeklySalesReport(startDateStr, user) {
    ...
    async getMonthlySalesReport(yearStr, monthStr, user) {
    ...
    async getSalesMetrics(daysStr = '30', user) {
        const days = parseInt(daysStr, 10);
        return this.reportsService.getSalesMetrics(user.shopId, days);
    }
    async getTrendAnalysis(daysStr = '30', user) {
        const days = parseInt(daysStr, 10);
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], ReportsController.prototype, "getSalesMetrics", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('admin'),
