 ...
 * Or add to package.json: "setup:super-admin": "node scripts/setup-super-admin.js"
 */
...
async function setupSuperAdmin() {
  try {
    ...
    if (existingAdmin) {
      ...
      console.log('ℹ️  To reset password, delete the document and run this script again.\n');
