...
export const metadata: Metadata = {
  title: 'SmartDuka Features - POS, Inventory, M-Pesa & Analytics | Kenya',
  description: 'Explore SmartDuka features: Fast POS checkout, real-time inventory management, M-Pesa integration, sales analytics, and employee management for Kenyan retailers.',
  keywords: [
    'POS features Kenya',
  ...
  openGraph: {
    ...
    description: 'Complete feature overview of Kenya\'s best POS and inventory management system.',
    type: 'website',
    locale: 'en_KE',
  },
  alternates: {
    canonical: 'https://smartduka.co.ke/features',
  },
};
