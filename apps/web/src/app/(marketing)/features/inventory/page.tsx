...
export const metadata: Metadata = {
  title: 'Inventory Management Software Kenya - Stock Tracking | SmartDuka',
  description: 'Complete inventory management for Kenyan retailers. Real-time stock tracking, low stock alerts, supplier management, multi-branch sync, and detailed reports.',
  keywords: [
    'inventory management Kenya',
    'stock tracking software',
    'inventory software Nairobi',
    'stock control system',
    'warehouse management Kenya',
    'supplier management software',
    'multi-branch inventory',
    'retail inventory Kenya',
  ],
  openGraph: {
    title: 'Inventory Management Software Kenya | SmartDuka',
    description: 'Real-time stock tracking with low stock alerts. Perfect for Kenyan retail businesses.',
    type: 'website',
    locale: 'en_KE',
  },
  alternates: {
    canonical: 'https://smartduka.co.ke/features/inventory',
  },
};
...
export default function InventoryFeaturePage() {
  return (
    <div className="min-h-screen bg-white">
      <BreadcrumbJsonLd 
        items={[
          { name: 'Home', url: 'https://smartduka.co.ke' },
          { name: 'Features', url: 'https://smartduka.co.ke/features' },
          { name: 'Inventory Management', url: 'https://smartduka.co.ke/features/inventory' },
        ]} 
      />
