...
export const metadata: Metadata = {
  title: 'POS System Kenya - Fast Point of Sale Software | SmartDuka',
  description: 'SmartDuka POS system for Kenyan retailers. Fast checkout, barcode scanning, M-Pesa payments, offline mode, and receipt printing. Start your free trial today!',
  keywords: [
    'POS system Kenya',
  ...
  openGraph: {
    title: 'POS System Kenya - Fast Point of Sale Software | SmartDuka',
    description: 'Fast, reliable POS system with M-Pesa integration. Perfect for Kenyan retail businesses.',
    type: 'website',
    locale: 'en_KE',
  },
  alternates: {
    canonical: 'https://smartduka.co.ke/features/pos',
  },
};
    ...
    <div className="min-h-screen bg-white">
      <BreadcrumbJsonLd 
        items={[
          ...
          { name: 'POS System', url: 'https://smartduka.co.ke/features/pos' },
        ]} 
      />
