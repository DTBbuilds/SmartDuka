...
export const metadata: Metadata = {
  title: 'Sales Analytics & Reports Kenya - Business Intelligence | SmartDuka',
  description: 'Powerful sales analytics and reporting for Kenyan retailers. Track sales trends, profit margins, employee performance, and inventory turnover with real-time dashboards.',
  keywords: [
    'sales analytics Kenya',
    'retail reports software',
    'business intelligence Kenya',
    'sales tracking system',
    'profit analysis software',
    'retail dashboard Kenya',
    'POS reports',
    'inventory analytics',
  ],
  openGraph: {
    title: 'Sales Analytics & Reports Kenya | SmartDuka',
    description: 'Real-time sales analytics and reporting for smarter business decisions.',
    type: 'website',
    locale: 'en_KE',
  },
  alternates: {
    canonical: 'https://smartduka.co.ke/features/analytics',
  },
};
    ...
    <div className="min-h-screen bg-white">
      <BreadcrumbJsonLd 
        items={[
          ...
          { name: 'Analytics', url: 'https://smartduka.co.ke/features/analytics' },
        ]} 
      />
