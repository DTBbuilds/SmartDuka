...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://smartduka.co.ke/blog/${slug}`,
    },
  };
}
    ...
    <div className="min-h-screen bg-white">
      <ArticleJsonLd 
        article={{
          title: post.title,
          description: post.excerpt,
          image: `https://smartduka.co.ke${post.image}`,
          datePublished: post.date,
          author: post.author,
          url: `https://smartduka.co.ke/blog/${slug}`,
        }}
      />
      <BreadcrumbJsonLd 
        items={[
          { name: 'Home', url: 'https://smartduka.co.ke' },
          { name: 'Blog', url: 'https://smartduka.co.ke/blog' },
          { name: post.title, url: `https://smartduka.co.ke/blog/${slug}` },
        ]} 
      />
