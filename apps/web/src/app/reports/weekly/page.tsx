...
export default function WeeklySalesPage() {
  ...
  const [salesData, setSalesData] = useState<WeeklySales | null>(null);
  ...
  return (
    <div className="container py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">View sales performance by week</p>
      </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                disabled={selectedWeek >= getCurrentWeek()}
              >
                Next Week
              </Button>
            </div>
