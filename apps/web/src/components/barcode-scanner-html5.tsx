...
export function BarcodeScannerHtml5({
  ...
  const initScanner = useCallback(async () => {
    ...
    try {
      ...
      // 1. html5-qrcode's getCameras() and start() already call getUserMedia
      // 2. Double camera access can cause "camera in use" errors on mobile
      // 3. The permission prompt will be triggered by html5-qrcode's getUserMedia call
      console.log('[Scanner] Proceeding to html5-qrcode initialization...');
