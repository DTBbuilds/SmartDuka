...
export function OrganizationJsonLd() {
  const schema = {
    ...
    knowsAbout: ['Free Point of Sale Software', 'Open Source POS', 'Inventory Management', 'Retail Technology', 'Free POS Systems'],
  };
...
export function SoftwareApplicationJsonLd() {
  const schema = {
    ...
    description: '100% free, open source point of sale and inventory management software. No subscriptions, no hidden fees, no user data collected. Real-time stock tracking, sales reports, barcode scanning, M-Pesa integration, and multi-store support.',
    ...
    offers: {
      ...
      description: 'SmartDuka is 100% free for all users. No subscriptions required.',
    },
    aggregateRating: {
    ...
    featureList: [
      ...
      'Free Inventory and Stock Management',
    ...
    softwareVersion: '2.0',
    downloadUrl: 'https://www.smartduka.org/register-shop',
...
export function WebSiteJsonLd() {
  const schema = {
    ...
    description: 'Free, open source Point of Sale & Inventory Management Software by DTB Technologies. No subscriptions, no data collection.',
    url: 'https://www.smartduka.org',
    publisher: {
      '@type': 'Organization',
      '@id': 'https://www.smartduka.org/#organization',
